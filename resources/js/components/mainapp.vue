        ...
        <div class="_1side_menu_content">
          ...
          <div class="_1side_menu_list">
            <ul class="_1side_menu_list_ul">
              ...
              <li><router-link to="/"><Icon type="ios-arrow-forward" /> Dashboard</router-link></li>
              <li><router-link to="products"><Icon type="ios-arrow-forward" /> Products</router-link></li>
              <li><router-link to="categories"><Icon type="ios-arrow-forward" /> Categories</router-link></li>
